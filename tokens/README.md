...
- `color.bg.page`, `color.bg.surface`, `color.bg.surface.raised|nested|overlay`, `color.bg.fill.inverse|inverse-media|accent|accent-strong|critical`, `color.bg.fill.inverse-pressed|inverse-media-pressed` (the pressed solids, ADR-0039), `color.bg.fill.neutral.subtle`, `color.bg.tint.accent|success|warning|critical|info`
