...
| G-11 | high | `web/packages/tokens/package.json:24` | Decide Prism's licence in an ADR, add LICENSE at the root and to each package, and add a self entry to the inventory. Resolved 2026-09-15 by ADR-0028 (MIT). | new |
