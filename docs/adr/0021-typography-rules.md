...
- Status: accepted (§11 emission layout amended by [ADR-0027](0027-font-emission-layout-and-manifest-names.md); §5's `metric.md` figures, §1's watch hero size and the role list amended by [ADR-0030](0030-semantic-roles-from-the-direction-board.md): `metric.md` is proportional, the `watch` platform context sets `metric.xl` at 40 px, and `axis` joins the roles)
- Date: 2026-09-15
