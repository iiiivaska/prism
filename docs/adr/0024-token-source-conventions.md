...
- Status: accepted (§4.1 amended by [ADR-0020](0020-brand-model.md): `app.prism.alpha` is the one folded key an alias declares; §13.3 manifest CSS names amended by [ADR-0027](0027-font-emission-layout-and-manifest-names.md))
- Date: 2026-09-15
