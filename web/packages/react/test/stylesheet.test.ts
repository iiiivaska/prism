...
describe("the source stylesheets (ADR-0019 rule 9, ADR-0025 rule 2)", () => {
  it("exist: the entry and one stylesheet per component", () => {
    expect(sources.map((file) => relative(srcRoot, file))).toEqual(["badge/Badge.css", "button/Button.css", "card/Card.css", "divider/Divider.css", "icon/Glyph.css", "icon/Icon.css", "styles.css", "surface/Surface.css", "text/Text.css"]);
  });
...
describe("the compiled styles.css (ADR-0019 rules 9 and 10)", () => {
  ...
  it("imports every component stylesheet, Card after the Surface it refines", () => {
    ...
    expect(imports).toEqual(["surface/Surface.css", "text/Text.css", "icon/Glyph.css", "icon/Icon.css", "button/Button.css", "card/Card.css", "divider/Divider.css", "badge/Badge.css"]);
  });
