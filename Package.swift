...
let package = Package(
    ...
    targets: [
        // Generated by the token build (tools/tokens). Never hand-edited.
        // `resources: [.process("Resources")]` returns with the generated Colors.xcassets (P1-5):
        // an empty resource folder yields a bundle that codesign rejects on iOS and watchOS.
        .target(
            name: "DSTokens",
