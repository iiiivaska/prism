...
/// The SwiftUI snapshots of roadmap P3-3: every spec example of Surface, Text, Button, Card, Divider, Icon, Badge and
/// IconButton (`DSExamples`, which the `#Preview` blocks show) in light/dark × regular/compact × standard/Increase Contrast, plus
